...
@Component({
    ...
    <div class="admin-wrapper">
      ...
      <header class="admin-mobile-bar">
        <button class="mobile-toggle" (click)="sidebarOpen = !sidebarOpen" [class.open]="sidebarOpen">
          <span></span><span></span><span></span>
        </button>
        <span class="mobile-title">دار شمس — لوحة التحكم</span>
      ...
      <aside class="sidebar" [class.open]="sidebarOpen">
        ...
        <nav class="sidebar-nav">
          <a routerLink="/admin/dashboard" routerLinkActive="active" [routerLinkActiveOptions]="{exact: true}" (click)="sidebarOpen = false">
          ...
          <a routerLink="/admin/orders" routerLinkActive="active" (click)="sidebarOpen = false">
          ...
          <a routerLink="/admin/books" routerLinkActive="active" (click)="sidebarOpen = false">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20"/></svg>
            <span>الكتب</span>
          </a>
          <a routerLink="/admin/authors" routerLinkActive="active" (click)="sidebarOpen = false">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"/><path d="M16.376 3.622a1 1 0 0 1 3.002 3.002L7.368 18.635a2 2 0 0 1-.855.506l-2.872.838a.5.5 0 0 1-.62-.62l.838-2.872a2 2 0 0 1 .506-.854z"/></svg>
            <span>المؤلفون</span>
          </a>
          <a routerLink="/admin/gallery" routerLinkActive="active" (click)="sidebarOpen = false">
          ...
          <a routerLink="/admin/customers" routerLinkActive="active" (click)="sidebarOpen = false">
          ...
          <a routerLink="/admin/reports" routerLinkActive="active" (click)="sidebarOpen = false">
        ...
        <div class="sidebar-footer">
          <a routerLink="/" class="btn-storefront" (click)="sidebarOpen = false">
      ...
      <main class="admin-content">
        <header class="topbar">
          <div class="user-info">مرحبا، {{ (authService.profile$ | async)?.full_name || 'المدير' }}</div>
        </header>
        <div class="content-body"><router-outlet></router-outlet></div>
      </main>
...
export class AdminLayoutComponent {
    ...
    async logout() { await this.authService.signOut(); this.router.navigate(['/login']); }
}
